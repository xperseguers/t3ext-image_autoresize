...
`Observer pattern <https://en.wikipedia.org/wiki/Observer_pattern>`_ in software, something similar to *hooks* in former
versions of TYPO3. Its implementation in TYPO3 CMS has been backported from Flow, so please read chapter
`Signals and Slots <https://docs.typo3.org/flow/TYPO3FlowDocumentation/TheDefinitiveGuide/PartIII/SignalsAndSlots.html>`_
