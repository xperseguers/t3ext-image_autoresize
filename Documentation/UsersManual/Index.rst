...
.. figure:: ../Images/example_autoresize.png
...
Here is another example, from a content element "text w/image" where a BMP (``screenshot.bmp``, 3.2 MB, 1184 × 884) has
been added to the list of associated images:

.. figure:: ../Images/example_converted.png
	:alt: Example of an image that has been automatically converted from one format to another

The uploaded file screenshot.bmp has automatically been both resized and converted to a new file ``screenshot.jpg``
(according to the image type conversion mapping option described in chapter :ref:`admin-manual`).
